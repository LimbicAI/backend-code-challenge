 ...
 * @param data
 */
var saveUser = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    var user, savedUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user = new User_1.default(__assign({}, data));
...
var createUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var isUsernameAvailable, newUser, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 5, , 6]);
            ...
            case 1:
                ...
                if (!isUsernameAvailable) return [3 /*break*/, 2];
                res.status(404).json({
                    message: "Please select a different username, that one is already taken",
                });
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, saveUser(req.body)];
            case 3:
                newUser = _a.sent();
                if (newUser) {
...
var getUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userName, userDetails, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
